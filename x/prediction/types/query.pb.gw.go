...
var (
	filter_Query_Orders_0 = &utilities.DoubleArray{Encoding: map[string]int{"market_id": 0, "outcome_index": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
func request_Query_Orders_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	val, ok = pathParams["outcome_index"]
	if !ok {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "missing parameter %s", "outcome_index")
	}

	protoReq.OutcomeIndex, err = runtime.Uint32(val)

	if err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "outcome_index", err)
	}
...
var (
	filter_Query_UserOrders_0 = &utilities.DoubleArray{Encoding: map[string]int{"user": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"speculod", "prediction", "v1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Markets_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"speculod", "prediction", "v1", "markets"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Market_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"speculod", "prediction", "v1", "markets", "market_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Orders_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 2, 7}, []string{"speculod", "prediction", "v1", "markets", "market_id", "outcomes", "outcome_index", "orders"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Order_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"speculod", "prediction", "v1", "orders", "order_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_OrderBook_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 2, 7}, []string{"speculod", "prediction", "v1", "markets", "market_id", "outcomes", "outcome_index", "orderbook"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_UserOrders_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"speculod", "prediction", "v1", "users", "user", "orders"}, "", runtime.AssumeColonVerbOpt(false)))
)
