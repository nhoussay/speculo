...
# Enhanced blockchain startup script with P2P peer discovery
# This script handles both persistent and peer node configurations
...
case $NODE_TYPE in
    ...
    "peer")
        ...
        if [ -n "$PERSISTENT_PEERS" ]; then
            echo "Will connect to persistent peers: $PERSISTENT_PEERS"
        fi
        ;;
    *)
