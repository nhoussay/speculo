...
class P2PWebSocketBridge:
    ...
    async def forward_websocket_to_tcp(self, websocket, tcp_socket, client_id: str):
    ...
    async def forward_tcp_to_websocket(self, tcp_socket, websocket, client_id: str):
    ...
    async def send_error_message(self, websocket, error_msg: str):
